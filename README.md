...
- **API Base**: `http://localhost:3000/chatbot/api` (recursos versionados em `/chatbot/api/v1/...`)
- **Health Check**: `http://localhost:3000/chatbot/api/health` (público, sem versionamento)
- **Documentação Swagger**: `http://localhost:3000/api/docs`
- **Keycloak Admin**: `http://localhost:8080/auth` (admin/admin, realm: `Local`)
- **Usuários de teste**: `admin`/`admin` (roles `sys_chatbot-admin` e `sys_chatbot-users`) e `user`/`user` (role `sys_chatbot-users`)
